...
const Tabs: React.FunctionComponent<Props> = (props: Props) => {
  ...
  return (
    <ul className="movie-nav__list">
      ...
      >
        <a style={{cursor: `pointer`}} className="movie-nav__link">Overview</a>
      </li>
      ...
      >
        <a style={{cursor: `pointer`}} className="movie-nav__link">Details</a>
      </li>
      ...
      >
        <a style={{cursor: `pointer`}} className="movie-nav__link">Reviews</a>
      </li>
    </ul>
  );
};
