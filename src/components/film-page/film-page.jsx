...
const FilmPage = (props) => {
  const {title, genre, releaseDate, backgroundFilmPoster, filmPoster, ratingScore, ratingLevel, ratingCount, filmDescription, filmDirector, filmStarring} = props;
        ...
        <div className="movie-card__wrap movie-card__translate-top">
          <div className="movie-card__info">
            <div className="movie-card__poster movie-card__poster--big">
              <img src={filmPoster} alt={title} width="218"
                height="327"/>
            </div>
            ...
            <div className="movie-card__desc">
              ...
              <div className="movie-card__text">
                ...
                <p className="movie-card__director"><strong>{filmDirector}</strong></p>

                <p className="movie-card__starring"><strong>{filmStarring}</strong></p>
              </div>
            </div>
          </div>
        </div>
